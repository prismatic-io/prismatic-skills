...
1. Search for available connections: `npx tsx scripts/shared/search-connections.ts <platform>`
...
1. ✅ **Search:** `search-components.ts <system>`
...
Use `search-components.ts` to discover available components by keyword.
