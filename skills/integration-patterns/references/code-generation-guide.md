...
1. Search for available connections: `npx tsx scripts/integrations/search-connections.ts <platform>`
...
1. ✅ **Search:** `find-components.ts <system>`
...
Use `find-components.ts` to discover available components by keyword.
