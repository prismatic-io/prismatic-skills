...
// Pins the builder API surface: prismatic.showWorkflows and the WORKFLOW_ENABLED /
// WORKFLOW_DISABLED events (not marketplace INSTANCE_* events). Non-tautology: the
// prompt names no SDK symbol; both come only from workflow-builder.md and sdk-api.md.
...
customer's workflows, and explain how we can tell when a customer turns one of their
workflows on or off.`,
  ),
  driver: claudeCode({
