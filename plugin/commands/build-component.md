...
<procedure name="workflow">
  ...
  <step name="gather-requirements">
    ...
    <loop name="requirement-loop">
      ...
      <substep>If api_docs_url was just answered, spawn external-api-researcher with the URL AND the session directory path. Output MUST go to {session_dir}/api-research.json. WAIT for results before continuing.</substep>
